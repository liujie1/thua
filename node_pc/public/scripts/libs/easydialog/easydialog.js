...
var dialogBox = function(){
	...
	return (function(){
		...
		dialogBox.style.cssText = 'margin:0;padding:0;border:none;z-index:9999;';
...
var base = {
	open : function(_opt){
		...
		if(typeof options.container === 'string'){
			...
			if (typeof _opt.fixedWidth === 'string') {
				eWidth = _opt.fixedWidth;
			}
			// 强制去掉弹出层内容的margin
