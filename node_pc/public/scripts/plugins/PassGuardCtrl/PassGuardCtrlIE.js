		...
		prototype: {
			...
			getpgeHtml: function() {
				if (this.osBrowser==1 || this.osBrowser==3) {
					...
					var pgeOcx='<embed onmouseover="'+ff+'" onfocus="'+this.settings.pgeOnfocus+'" onblur="'+this.settings.pgeOnblur+'" ID="' + this.settings.pgeId + '"  maxlength="'+this.settings.pgeMaxlength+'" input_603="'+this.settings.placeholderFont+'"   input_604="'+this.settings.placeholderSize+'"  input_2="'+this.settings.pgeEreg1+'" input_3="'+this.settings.pgeEreg2+'" edittype="'+this.settings.pgeEdittype+'" type="application/thfpass-guard-x32" tabindex="'+this.settings.pgeTabindex+'" class="' + this.settings.pgeClass + '" ';
					...
					this.checkInstall(1,function(obj){
						...
						if((obj.getConvertVersion(objVersion)<obj.getConvertVersion(PGEdit_Edge_VERSION))&&PGEdit_Update=="1"){
							...
							$("#"+id+"_down").parent().html('<input placeholder="' + obj.settings.pgePlaceHolder + '" type="password" onfocus="'+fos+'pgeCtrl.openProt(\''+winId+'\',this.id);pgeCtrl.setCX(this);'+obj.settings.pgeOnfocus+'" autocomplete="off" onkeydown="pgeCtrl.setSX(event,\''+obj.settings.pgeOnkeydown+'\',this);" onclick = "pgeCtrl.setCX(this)" onblur = "pgeCtrl.closeProt(\''+winId+'\',this.id);'+obj.settings.pgeOnblur+'" id = "'+id+'" style="ime-mode:disabled" tabindex="2" class="' + obj.settings.pgeClass + '"/>');
