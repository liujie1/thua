			...
			getpgeHtml: function() {
				if (this.osBrowser==1 || this.osBrowser==3) {
					return '<span id="'+this.settings.pgeId+'_pge" class="'+this.settings.passLoginStyle+'"><OBJECT ID="' + this.settings.pgeId + '" CLASSID="CLSID:' + this.pgeditIEClassid + '" codebase="' 
							...
							+ '<param name="input2" value="'+ this.settings.pgeEreg1 + '"><param name="input12" value="'+ this.settings.pgePlaceHolder +'"><param name="input3" value="'+ this.settings.pgeEreg2 + '"></OBJECT></span>'
					...
					var pgeOcx='<embed onmouseover="'+ff+'" onfocus="'+this.settings.pgeOnfocus+'" onblur="'+this.settings.pgeOnblur+'" ID="' + this.settings.pgeId + '"  maxlength="'+this.settings.pgeMaxlength+'" input_2="'+this.settings.pgeEreg1+'" input_3="'+this.settings.pgeEreg2+'" edittype="'+this.settings.pgeEdittype+'" type="application/thfpass-guard-x32" tabindex="'+this.settings.pgeTabindex+'" class="' + this.settings.pgeClass + '" ';
